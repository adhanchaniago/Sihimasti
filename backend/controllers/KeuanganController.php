...
use backend\models\KeuanganSearch;
...
class KeuanganController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            $model->save();
            $modelPrev = Keuangan::getNextOrPrevId($model->id, "prev");
            if($modelPrev != null){
                $model->saldo = ($modelPrev->saldo + $model->pemasukan) - $model->pengeluaran;
            } else {
                $model->saldo = $model->pemasukan - $model->pengeluaran;
            }
